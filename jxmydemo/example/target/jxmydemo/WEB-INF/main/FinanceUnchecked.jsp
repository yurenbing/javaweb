...
<div class="item-main">
    <table>
        <tr>
            ...
            <td style="width:5px"></td>
            <td><input type="button" value="查找" class="l-button" style="width:50px;color:red;" onclick="selectFinanceUnCheckInfo()"></input></td>
            <td style="width:5px"></td>
...
<script type="text/javascript">
    ...
    var financeUnchecked=$("#FinanceUnchecked").ligerGrid({
        width:'100%',
        height:'100%',
        rowHeight:30,
        headerRowHeight:30,
        ...
        columns: [
                ...
                (rowdata, rowindex, value)
            {
                ...
                if (!rowdata._editing)
                {
                    h += "<a href='javascript:check("+rowdata.checkId+")'>审批</a> ";
                }
                return h;
            }
            },
        ...
        dataAction:'local',
        url:"selectFinanceunchecked.do",
    });

    function check(data) {
        var tabid="financeUnchecked"+data;
        parent.f_addTab(tabid,"财务审批","FinanceUnCheckForm.jsp?id="+data);
    }

    function refreshGather() {
        financeUnchecked.set({url:'selectFinanceunchecked.do'});
        financeUnchecked.reload();
    }

    function selectFinanceUnCheckInfo() {
        financeUnchecked.set({url:'selectFinanceUnCheckInfo.do?projetName='+$(".projetName").val()});
        financeUnchecked.reload();
    }
