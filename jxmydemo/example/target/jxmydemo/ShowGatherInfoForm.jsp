...
<form action="insertGatherInfo.do"  method="post" id="GatherInfoForm" enctype="multipart/form-data">
    ...
    <table style="width:720px;border:1px solid;border-collapse: collapse;" data-sort="sortDisabled" align="center">
        ...
        <tr>
            ...
            <td align="center" colspan="1" rowspan="1" style="word-break: break-all;">
                <strong><input readonly="readonly" type="text" class="wf_field payUnit" name="payUnit" otype="select" odata="{&#39;dataType&#39;:&#39;str&#39;,&#39;dataItems&#39;:[{&#39;name&#39;:&#39;ͬ��&#39;,&#39;value&#39;:&#39;&#39;},{&#39;name&#39;:&#39;��ͬ��&#39;,&#39;value&#39;:&#39;&#39;}],&#39;width&#39;:&#39;100&#39;,&#39;style&#39;:&#39;0&#39;}" style="white-space: normal; width: 98%;"/></strong>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="1" rowspan="1" style="word-break: break-all;">
            ...
            <td align="center" colspan="1" rowspan="1" style="word-break: break-all;">
                <strong><input readonly="readonly" type="text" value="" class="wf_field gatherDate" name="gatherDate" otype="select" odata="{&#39;dataType&#39;:&#39;str&#39;,&#39;dataItems&#39;:[{&#39;name&#39;:&#39;ͬ��&#39;,&#39;value&#39;:&#39;&#39;},{&#39;name&#39;:&#39;��ͬ��&#39;,&#39;value&#39;:&#39;&#39;}],&#39;width&#39;:&#39;100&#39;,&#39;style&#39;:&#39;0&#39;}" style="white-space: normal; width: 98%;"/></strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td rowspan="1" colspan="3">
                <textarea rows="5" class="gatherNote" style="width: 100%;height: 100%" name="gatherNote" readonly="readonly"></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        $.ajax({
            type:"get",
            data:{
                gatheringId:${param.id},
            },
            datatype:"text",
            url:"showGatherInfoForm.do",
            success:function (data) {
                alert(data);
                var info=JSON.parse(data);
                $(".payUnit").val(info.payUnit);
                $(".totalMoney").val(info.totalMoney);
                $(".projetName").val(info.projetName);
                $(".projectInfo").val(info.projectInfo);
                $(".gatherDate").val(date(info.gatherDate));
                $(".gatherNote").val(info.gatherNote);
            }
        });
